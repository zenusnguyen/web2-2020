...
-- ----------------------------
-- Sequence structure for currency_unit_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."currency_unit_id_seq";
CREATE SEQUENCE "public"."currency_unit_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
CREATE TABLE "public"."currency_unit" (
  "id" int4 NOT NULL DEFAULT nextval('currency_unit_id_seq'::regclass),
...
CREATE TABLE "public"."customer_infor" (
  ...
  "created_at" timestamptz(6),
  "updated_at" timestamptz(6),
  "identificationNumber" varchar(32) COLLATE "pg_catalog"."default",
  "date_of_issue" date,
...
CREATE TABLE "public"."identity_card" (
  ...
  "date_of_issue" date,
  "type" int4,
  "image1" varchar(255) COLLATE "pg_catalog"."default",
  "image2" varchar(255) COLLATE "pg_catalog"."default"
)
;
...
CREATE TABLE "public"."spend_account" (
  "account_id" int4,
  "currency_unit" varchar(255) COLLATE "pg_catalog"."default",
  "balance" float8,
  "closed_date" date,
...
ALTER SEQUENCE "public"."currency_unit_id_seq"
OWNED BY "public"."currency_unit"."id";
SELECT setval('"public"."currency_unit_id_seq"', 2, false);
ALTER SEQUENCE "public"."customer_infor_id_seq"
OWNED BY "public"."customer_infor"."id";
SELECT setval('"public"."customer_infor_id_seq"', 28, true);
ALTER SEQUENCE "public"."identity_card_id_seq"
OWNED BY "public"."identity_card"."id";
SELECT setval('"public"."identity_card_id_seq"', 2, false);
...
SELECT setval('"public"."spend_account_infor_id_seq"', 15, true);
...
SELECT setval('"public"."upload_file_id_seq"', 55, true);
...
SELECT setval('"public"."users-permissions_permission_id_seq"', 317, true);
...
SELECT setval('"public"."users-permissions_user_id_seq"', 18, true);
...
-- ----------------------------
ALTER TABLE "public"."currency_unit" ADD CONSTRAINT "currency_unit_pkey" PRIMARY KEY ("id");
